...
from .asr_audio import SAMPLE_RATE, detect_speech_by_energy, patch_mlx_whisper_audio_loader
from .config import (
...
class FasterWhisperASR:
    ...
    def detect_speech(self, wav_path: Path) -> List[Dict[str, int]]:
        try:
            ...
            self.last_error = ""
            return detect_speech_by_energy(wav_path)
...
class MlxWhisperASR(FasterWhisperASR):
    ...
    def _transcribe_on_worker(
        ...
        patch_mlx_whisper_audio_loader(mlx_whisper, ASRUnavailable)
