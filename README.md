...
> Version `0.0.3` is a macOS-first release. Windows and Linux are not packaged yet.
...
- Apple Silicon: `VoiceMeeting_0.0.3_aarch64.dmg`
...
> `0.0.3` 是 macOS 首发版本，暂时只提供 Mac 安装包。
